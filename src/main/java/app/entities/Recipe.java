...
public class Recipe {
    ...
    private app.security.entities.User owner;
    ...
    public app.security.entities.User getOwner() { return owner; }
    public void setOwner(app.security.entities.User o) { this.owner = o; }
